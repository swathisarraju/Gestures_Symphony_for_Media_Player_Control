...
def main():
    ...
    <h1 style="color:black;text-align:center;">Hand Gesture Recognition</h1>
    </div>
    """
    ...
    pages=['About Project','Gesture Control Page']
...
#     """
   # st.sidebar.markdown(html_temp, unsafe_allow_html=True)
    ...
    if add_pages=='About Project':
        html_temp2 = """
    <body style="background-color:white;padding:10px;">
    <h3 style="color:#C39BD3 ;text-align:center;">About Project</h3>
